def show_beginner_page():
    print("\n=== Learn the Basics ===\n")

    print("What is a command?")
    print("A command is a statement that gives a computer instructions.\n")

    print("What is the command prompt?")
    print("It is a hub where you can give your computer instructions or commands.\n")

    print("What is privacy in the Digital Age?")
    print("Privacy means keeping all of your information safe and protected.\n")
